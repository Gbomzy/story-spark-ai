...
export const PROVIDERS: ProviderDef[] = [
  ...
  { id: "lovable-gemini-image", name: "Lovable AI · Gemini Image", vendor: "Lovable / Google", capabilities: ["images"], status: "connected", description: "Scene image generation via the Lovable AI Gateway (Nano Banana 2)." },
  ...
  { id: "flux", name: "Flux", vendor: "Black Forest Labs", capabilities: ["images"], status: "coming_soon", description: "Alternative high-fidelity scene image generation." },
